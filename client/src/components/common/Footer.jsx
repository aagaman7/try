      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Strength Training</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Cardio Fitness</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Personal Training</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Yoga Classes</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Nutrition Consulting</a>
              </li>
            </ul>
          </div>
